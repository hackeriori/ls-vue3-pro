import"./base-B4mn-k-B.js";import{E as _}from"./el-scrollbar-C5ouECZN.js";import{d as c,a as L}from"./ExampleBox-Ce_LokWD.js";import{a2 as F,d,j as m,a as f,A as n,f as i,w as a,t as p,o as v,g as N}from"./index-Cx6CCqNW.js";import"./install-O06-IG97.js";import"./index-DUziaiTX.js";import"./index-CxKK6j5m.js";let x=1e4;function b(r,o){let t;async function s(){await r(),t=setTimeout(s,o||x)}s(),F(()=>clearTimeout(t))}function w(r,o){r.forEach(t=>b(t,o))}function y(r){x=r}const T={class:"ls-text-halfLine"},g=d({__name:"LoopFunctionExp",setup(r){const o=m(0);async function t(){return new Promise(s=>{setTimeout(()=>{o.value++,s(void 0)})})}return b(t,1e3),(s,u)=>(v(),f("div",T,[u[1]||(u[1]=n("h2",null,"setupLoopFunction，循环调用单一方法",-1)),u[2]||(u[2]=n("pre",null,`/**
 * 循环调用单一方法
 * @param event 耗时方法
...
<\/script>`,-1)])),default:a(()=>[n("h4",null,p(o.value),1),i(l,{onClick:s},{default:a(()=>e[0]||(e[0]=[N("更改默认间隔")])),_:1})]),_:1})])}}}),D={class:"height100",style:{padding:"0.5em","box-sizing":"border-box"}},z=d({__name:"LoopFunctionTest",setup(r){return(o,t)=>{const s=_;return v(),f("div",D,[i(s,null,{default:a(()=>[t[0]||(t[0]=n("div",{class:"ls-text-line"},[n("h1",null,"setupLoopFunction，setupLoopFunctions用于循环调用耗时方法，例如在页面中轮询接口。"),n("h3",null,"调用时会等待耗时方法执行，执行完毕后，等待时间间隔（默认10000ms）再次调用耗时方法。避免过快执行耗时方法（例如请求接口）")],-1)),i(g),i(E),i(k)]),_:1})])}}});export{z as default};
