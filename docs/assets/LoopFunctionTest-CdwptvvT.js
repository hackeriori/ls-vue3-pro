import"./base-Op_l8k2B.js";import{E as _}from"./el-scrollbar-nGQc_BzY.js";import{d as c,a as L}from"./ExampleBox-CiSa_htM.js";import{a2 as F,d,j as m,a as f,A as n,f as i,w as a,t as p,o as v,g as N}from"./index-BCLzAaPz.js";import"./install-Bjjr33yt.js";import"./index-BeX1gaoE.js";import"./index-fdAl261p.js";let x=1e4;function b(r,o){let t;async function s(){await r(),t=setTimeout(s,o||x)}s(),F(()=>clearTimeout(t))}function w(r,o){r.forEach(t=>b(t,o))}function y(r){x=r}const T={class:"ls-text-halfLine"},g=d({__name:"LoopFunctionExp",setup(r){const o=m(0);async function t(){return new Promise(s=>{setTimeout(()=>{o.value++,s(void 0)})})}return b(t,1e3),(s,u)=>(v(),f("div",T,[u[1]||(u[1]=n("h2",null,"setupLoopFunction，循环调用单一方法",-1)),u[2]||(u[2]=n("pre",null,`/**
 * 循环调用单一方法
 * @param event 耗时方法
