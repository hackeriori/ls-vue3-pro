export const importMap = {
  ...
  'ls-vue3-pro': import.meta.env.DEV ? '/lsVue3Pro.es.js' : 'https://unpkg.com/ls-vue3-pro@1.3.6/dist/lsVue3Pro.es.js'
}

export const importCss = [
  "https://unpkg.com/ls-base-lib@2.0.4/dist/css/ls.css",
  "https://unpkg.com/element-plus@2.9.7/dist/index.css",
  import.meta.env.DEV ? '/ls-vue3-pro.css' : 'https://unpkg.com/ls-vue3-pro@1.3.6/dist/ls-vue3-pro.css'
]