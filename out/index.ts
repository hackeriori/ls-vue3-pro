...
export {default as DynamicHeightVirtualList} from '../src/components/dynamicHeightVirtualList/DynamicHeightVirtualList.vue'
...
export * from '../src/directive/ellipsis'